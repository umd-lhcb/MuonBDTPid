#!/usr/bin/env python
# Author: Emily Jiang
# Last Change: Tues May 03, 2022 at 04:39 PM +0100
#
...
parser.add_argument('--lxplusUsr', type=str,
                   help='your username for lxplus')
...
for decay in files["data"]:
    for folder in files["data"][decay]:
        for mag in files["data"][decay][folder]:
            ...
            remoteDir = args.lxplusUsr+"@lxplus.cern.ch:"+files["data"][decay][folder][mag]+"/"
