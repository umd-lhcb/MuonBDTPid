...
LokiVarsByName = {
  ...
  "mu" : {
     "MuonTOS"  :      "switch((TOS('L0MuonDecision', 'L0TriggerTisTos')) & "\
                        ...
                        "1,0)"
     ,"MuonProbe" :     "switch((P>3000) & (BPVIPCHI2()>10) & (TRCHI2DOF<3), 1,0)"
...
tupleConfiguration = {
  ...
  "KSDD_PiP" : TupleConfig (
    Decay = "KS0 -> ^pi+ ^pi-"
    , InputLines     = ["Hlt2PIDKs2PiPiDDTurboCalib"]
    , Calibration   = "KS0DDCalib"
    , Filter        = None
    , Branches = {
        "KS" : Branch("^(KS0 -> pi+ pi-)", Type='H')
        , "tag"  : Branch("KS0 -> pi+ ^pi-", Type='T', isAlso = ['pi'])
  ...
  "OmegaL_KM" : TupleConfig (
    Decay = "[Omega- -> ^(Lambda0 -> ^p+ ^pi-) ^K-]CC"
    , InputLines    = ["Hlt2PIDOmega2LambdaKLLLTurboCalib"]
    , Calibration   = "OmegaL_Neg"
    , Filter        = filters.NegativeID
    , Branches = {
        "Omega" : Branch("^([Omega- -> (Lambda0 -> p+ pi-) ^K-]CC)", Type='H')
        , "L0"    : Branch("[Omega- -> ^(Lambda0 -> p+ pi-) K-]CC", Type='I')
        , "probe" : Branch("[Omega- -> (Lambda0 -> p+ pi-) ^K-]CC", Type='T', isAlso = ['K'])
        , "p"     : Branch("[Omega- -> (Lambda0 -> ^p+ pi-) K-]CC", Type='T')
        , "pi"    : Branch("[Omega- -> (Lambda0 -> p+ ^pi-) K-]CC", Type='T')
        }
    ),

  "OmegaL_KP" : TupleConfig (
    Decay = "[Omega- -> ^(Lambda0 -> ^p+ ^pi-) ^K-]CC"
    , InputLines    = ["Hlt2PIDOmega2LambdaKLLLTurboCalib"]
    , Calibration   = "OmegaL_Pos"
    , Filter        = filters.PositiveID
    , Branches = {
        "Omega" : Branch("^([Omega- -> (Lambda0 -> p+ pi-) ^K-]CC)", Type='H')
        , "L0" : Branch("[Omega- -> ^(Lambda0 -> p+ pi-) K-]CC", Type='I')
  ...
  "OmegaDDD_KM" : TupleConfig (
    Decay = "[Omega- -> ^(Lambda0 -> ^p+ ^pi-) ^K-]CC"
    , InputLines    = ["Hlt2PIDOmega2LambdaKDDDTurboCalib"]
    , Calibration   = "OmegaDDDCalib_Neg"
    , Filter        = filters.NegativeID
    , Branches = {
        "Omega" : Branch("^([Omega- -> (Lambda0 -> p+ pi-) ^K-]CC)", Type='H')
        , "L0"    : Branch("[Omega- -> ^(Lambda0 -> p+ pi-) K-]CC", Type='I')
  ...
  "OmegaDDD_KP" : TupleConfig (
    Decay = "[Omega- -> ^(Lambda0 -> ^p+ ^pi-) ^K-]CC"
    , InputLines    = ["Hlt2PIDOmega2LambdaKDDDTurboCalib"]
    , Calibration   = "OmegaDDDCalib_Pos"
    , Filter        = filters.PositiveID
    , Branches = {
        "Omega" : Branch("^([Omega- -> (Lambda0 -> p+ pi-) ^K-]CC)", Type='H')
        , "L0" : Branch("[Omega- -> ^(Lambda0 -> p+ pi-) K-]CC", Type='I')
...
#============ Protons ===============================#
  ...
  "Lam0DD_P" : TupleConfig (
    Decay =  "[Lambda0 -> ^p+ ^pi-]CC"
    , InputLines    = ["Hlt2PIDLambda2PPiDDTurboCalib"]
    , Calibration   = "Lam0DDCalib_Pos"
    , Filter        = filters.PositiveID
    , Branches = {
       "L0"      : Branch("^([Lambda0 -> p+ pi-]CC)", Type='H')
       , "probe" : Branch("[Lambda0 -> ^p+ pi-]CC", Type='T', isAlso=['p'])
  ...
  "Lam0DD_Pbar" : TupleConfig (
    Decay =  "[Lambda0 -> ^p+ ^pi-]CC"
    , InputLines    = ["Hlt2PIDLambda2PPiDDTurboCalib"]
    , Calibration   = "Lam0DDCalib_Neg"
    , Filter        = filters.NegativeID
    , Branches = {
       "L0"      : Branch("^([Lambda0 -> p+ pi-]CC)", Type='H')
       , "probe" : Branch("[Lambda0 -> ^p+ pi-]CC", Type='T', isAlso=['p'])
  ...
  "Lam0DD_HPT_P" : TupleConfig (
    Decay =  "[Lambda0 -> ^p+ ^pi-]CC"
    , InputLines    = ["Hlt2PIDLambda2PPiDDhighPTTurboCalib"]
    , Calibration   = "Lam0DDCalib_HPT_Pos"
    , Filter        = filters.PositiveID
    , Branches = {
       "L0"      : Branch("^([Lambda0 -> p+ pi-]CC)", Type='H')
       , "probe" : Branch("[Lambda0 -> ^p+ pi-]CC", Type='T', isAlso=['p'])
  ...
  "Lam0DD_HPT_Pbar" : TupleConfig (
    Decay =  "[Lambda0 -> ^p+ ^pi-]CC"
    , InputLines    = ["Hlt2PIDLambda2PPiDDhighPTTurboCalib"]
    , Calibration   = "Lam0DDCalib_HPT_Neg"
    , Filter        = filters.NegativeID
    , Branches = {
       "L0"      : Branch("^([Lambda0 -> p+ pi-]CC)", Type='H')
       , "probe" : Branch("[Lambda0 -> ^p+ pi-]CC", Type='T', isAlso=['p'])
  ...
  "Lam0DD_VHPT_P" : TupleConfig (
    Decay =  "[Lambda0 -> ^p+ ^pi-]CC"
    , InputLines    = ["Hlt2PIDLambda2PPiDDveryhighPTTurboCalib"]
    , Calibration   = "Lam0DDCalib_VHPT_Pos"
    , Filter        = filters.PositiveID
    , Branches = {
       "L0"      : Branch("^([Lambda0 -> p+ pi-]CC)", Type='H')
       , "probe" : Branch("[Lambda0 -> ^p+ pi-]CC", Type='T', isAlso=['p'])
  ...
  "Lam0DD_VHPT_Pbar" : TupleConfig (
    Decay =  "[Lambda0 -> ^p+ ^pi-]CC"
    , InputLines    = ["Hlt2PIDLambda2PPiDDveryhighPTTurboCalib"]
    , Calibration   = "Lam0DDCalib_VHPT_Neg"
    , Filter        = filters.NegativeID
    , Branches = {
       "L0"      : Branch("^([Lambda0 -> p+ pi-]CC)", Type='H')
       , "probe" : Branch("[Lambda0 -> ^p+ pi-]CC", Type='T', isAlso=['p'])
...
#============ Electrons ===============================     
EBranch = {'Pos': "[B+]cc ->  (J/psi(1S) -> ^e+  e-) [ K+]cc",
           'Neg': "[B+]cc ->  (J/psi(1S) -> e+  ^e-) [ K+]cc"}
# categories defined in StandardOfflineRequirements
...
#            , Input           =  ["root://eoslhcb.cern.ch//eos/lhcb/user/p/poluekt/PID/2017_TurCal_DST/00067725_00000705_2.fullturbo.dst"]
          )
...
#                        , mdstOutputFile = "PIDCALIB" # shouldn't change
                        , mdstOutputFile = "" # shouldn't change
